...
import mtk.kelompok.util.DBAdapter5;
 ...
 * 
 */
public class SoalActivity5 extends SherlockActivity implements OnClickListener
{
	private static final String	TAG			= SoalActivity5.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// instance dbAdapter
		mDb = DBAdapter5.getInstance(this);

		// get data soal
		mListQuiz = mDb.getAllSoal5();
	...
	private void setupTimer()
	{
		mCountDownTimer = new CountDownTimer(detik, 1000)
		{
			...
			public void onFinish()
			{
				...
				Toast.makeText(SoalActivity5.this, "Waktu Habis",
	...
	public void onClick(View v)
	{
		if (v == btnNext)
		{
			...
			} else
			{
				...
				Intent i = new Intent(SoalActivity5.this, ResultActivity5.class);
				i.putExtras(bundle);
				startActivity(i);
				finish();
