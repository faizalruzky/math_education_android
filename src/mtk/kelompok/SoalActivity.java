...
import mtk.kelompok.util.DBAdapter;
 ...
 * 
 */
public class SoalActivity extends SherlockActivity implements OnClickListener
{
	private static final String	TAG			= SoalActivity.class.getName();
	...
	public void onClick(View v)
	{
		if (v == btnNext)
		{
			...
			} else
			{
				...
				Intent i = new Intent(SoalActivity.this, ResultActivity.class);
				i.putExtras(bundle);
				startActivity(i);
				finish();
