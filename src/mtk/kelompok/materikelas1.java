...
public class materikelas1 extends Activity {
	ListView list1;
	String[] menu = new String[] { "Bilangan Cacah",
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        list1.setOnItemClickListener(new OnItemClickListener(){
        	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3){
        		Intent i = null;
        		if (position == 0){
        			i = new Intent(materikelas1.this, bilangancacah.class);}
        		
    			else if(position == 1){
    				i = new Intent(materikelas1.this, matematikaActivity.class);
    				finish();}
    			else{}
