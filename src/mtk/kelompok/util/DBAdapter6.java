...
public class DBAdapter6 extends SQLiteAssetHelper

{
    ...
    public static final String      TABLE_SOAL              = "tb_bangunruang";
    ...
    private static DBAdapter6        dbInstance              = null;
    ...
    private DBAdapter6(Context context)
    ...
    public static DBAdapter6 getInstance(Context context)

    {
...

        {
            ...
            dbInstance = new DBAdapter6(context);
