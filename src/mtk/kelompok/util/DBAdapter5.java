...
public class DBAdapter5 extends SQLiteAssetHelper

{
    ...
    public static final String      TABLE_SOAL              = "tb_bilanganpecahan";
    ...
    private static DBAdapter5        dbInstance              = null;
    ...
    private DBAdapter5(Context context)
    ...
    public static DBAdapter5 getInstance(Context context)

    {
...

        {
            ...
            dbInstance = new DBAdapter5(context);
