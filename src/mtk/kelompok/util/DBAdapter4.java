...
public class DBAdapter4 extends SQLiteAssetHelper

{
    ...
    public static final String      TABLE_SOAL              = "tb_bangundatar";
    ...
    private static DBAdapter4        dbInstance              = null;
    ...
    private DBAdapter4(Context context)
    ...
    public static DBAdapter4 getInstance(Context context)

    {
...

        {
            ...
            dbInstance = new DBAdapter4(context);
