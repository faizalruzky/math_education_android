...
public class materikelas2 extends Activity {
	ListView list1;
	String[] menu = new String[] { "Perkalian",
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        list1.setOnItemClickListener(new OnItemClickListener(){
        	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3){
        		Intent i = null;
        		if (position == 0){
        			i = new Intent(materikelas2.this, perkalian.class);}
        		
    			else if(position == 1){
    				i = new Intent(materikelas2.this, matematikaActivity.class);
    				finish();}
    			else{}
