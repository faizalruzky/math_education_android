...
import mtk.kelompok.util.DBAdapter4;
 ...
 * 
 */
public class SoalActivity4 extends SherlockActivity implements OnClickListener
{
	private static final String	TAG			= SoalActivity4.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// instance dbAdapter
		mDb = DBAdapter4.getInstance(this);

		// get data soal
		mListQuiz = mDb.getAllSoal4();
	...
	private void setupTimer()
	{
		mCountDownTimer = new CountDownTimer(detik, 1000)
		{
			...
			public void onFinish()
			{
				...
				Toast.makeText(SoalActivity4.this, "Waktu Habis",
	...
	public void onClick(View v)
	{
		if (v == btnNext)
		{
			...
			} else
			{
				...
				Intent i = new Intent(SoalActivity4.this, ResultActivity4.class);
				i.putExtras(bundle);
				startActivity(i);
				finish();
