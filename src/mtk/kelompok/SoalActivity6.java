...
import mtk.kelompok.util.DBAdapter6;
 ...
 * 
 */
public class SoalActivity6 extends SherlockActivity implements OnClickListener
{
	private static final String	TAG			= SoalActivity6.class.getName();
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		// instance dbAdapter
		mDb = DBAdapter6.getInstance(this);

		// get data soal
		mListQuiz = mDb.getAllSoal6();
	...
	private void setupTimer()
	{
		mCountDownTimer = new CountDownTimer(detik, 1000)
		{
			...
			public void onFinish()
			{
				...
				Toast.makeText(SoalActivity6.this, "Waktu Habis",
	...
	public void onClick(View v)
	{
		if (v == btnNext)
		{
			...
			} else
			{
				...
				Intent i = new Intent(SoalActivity6.this, ResultActivity6.class);
				i.putExtras(bundle);
				startActivity(i);
				finish();
